  ...
  <div class="row">
    <div class="header">
      <h3 style="text-transform:uppercase;">
        &nbsp; &nbsp; Ingredient &nbsp;
        <a href="#addItem" class="btn btn-primary" data-toggle="modal" data-target="#addItem"><i
            class="fas fa-plus"></i> Item</a>
        <a href="#addStock" class="btn btn-primary" data-toggle="modal" data-target="#addStock"><i
            class="fas fa-plus"></i> Stock</a>
      </h3>
    </div>
          ...
          <table>
			...
			?>
                ...
                <td style="text-align:center;">
                  <button data-toggle="modal" data-target="#editProduct<?php echo $data['item_id']?>" type="button"
                    class="btn btn-primary bg-gradient-primary"><i class="fas fa-pen fa-m"> Edit</i></button>
                  <button href="admin_category.php?cat_del=<?php echo $data['item_id']?>" class="btn btn-danger"><i
                      class="fas fa-trash fa-m"> Delete</i></button>
                </td>
              </tr>
                    ...
                    <div class="modal-body">
                      <form method="POST" action="../libraries/editProduct.php" class="form-horizontal">
                        <div class="form-group">
                          <input type="hidden" class="form-control" value="<?php echo $data['item_id']?>" name="item_id"
                            readonly>
                        </div>
                        <div class="form-group">
                          <input type="text" placeholder="Barcode" name="barcode" value="<?php echo $data['SKU']?>"
                        ...
                        <div class="form-group">
                          <input type="number" placeholder="Quantity" name="quantity" value="<?php echo $data['qty']?>"
           ...
           ?>
                            <option value="<?php echo $data1['category_id']?>">
                              <?php echo strtoupper($data1['category_name'])?></option>
                            <?php endforeach; ?>
                          </select>
                        </div>
      ...
      <div class="modal-body">
        <form method="post" action="../libraries/addProduct.php" class="form-horizontal">
          ...
          <div class="form-group">
           ...
           foreach($result1 as $data1):
           ?>
              <option value="<?php echo $data1['category_id']?>"><?php echo strtoupper($data1['category_name'])?>
              </option>
              <?php endforeach; ?>
            </select>
          </div>
