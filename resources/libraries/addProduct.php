...
if (isset($_POST['save_item'])){
    ...
    $query = "SELECT * FROM ITEM WHERE ITEM_NAME = '$item_name' AND merchant_id = '$merchant'";
    ...
    <?php }
        ...
        mysqli_query($db,"INSERT INTO item(merchant_id,sku,item_name,description,category_id,qty,price,item_image,created_at)
        VALUES('$merchant','$sku','$item_name','$description','$category','$qty','$price','$pic','$date_stockin')")or die(mysqli_error($db));
        ?>
       <script type = "text/javascript">
